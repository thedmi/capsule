...
public class CapsuleSourceGeneratorTests
{
...
";
    ...
    public void GenerateReportMethod()
    {
        ...
        var generator = new CapsuleSourceGenerator();
        ...
        Assert.That(ExpectedGeneratedClassText.Trim() == generatedFileSyntax.GetText().ToString().Trim());
    }
}
